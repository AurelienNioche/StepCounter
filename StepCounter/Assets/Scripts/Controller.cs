...
public class Controller : MonoBehaviour
{
    ...
    private const string packageClass = "com.aureliennioche.stepcounterplugin.Bridge";
    private const string packageMethod = "launchService";

    private const string UnityJavaClass = "com.unity3d.player.UnityPlayer";
    ...
    public void LaunchSensorWorker()
    {
        if (Application.platform == RuntimePlatform.Android)
        {
            ...
            AndroidJavaClass unityPlayerClass = new AndroidJavaClass(UnityJavaClass);
